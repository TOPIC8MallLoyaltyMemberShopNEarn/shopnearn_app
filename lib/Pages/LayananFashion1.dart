...
class LayananFashion1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
          Image.asset(
            "/assets/jamtangan.jpg",
          ),
          Text(
            "Kaos Pria T-Shirt Distro",
            style: TextStyle(
              fontSize: 40.0,
              fontWeight: FontWeight.bold, // Ubah warna teks menjadi putih
            ),
          ),
          Text(
            "Rp 50.000",
            style: TextStyle(
                ...
                color: Colors.blue // Ubah warna teks menjadi putih
                ),
          ),
          ProductRow(products: products.sublist(0, 6)),
        ],
      ),
    );
  }
